                ...
                if (insnType == 8 || insnType == 15 || insnType == 14) {
                    ...
                    if (insnNode instanceof JumpInsnNode) {
                        ...
                        for (int i = 0; i < subroutine.callers.size(); ++i) {
                            ...
                            int call2 = this.insns.indexOf(caller);
                            if (this.frames[call2] == null) continue;
                            this.merge(call2 + 1, this.frames[call2], current, this.subroutines[call2], subroutine.access);
                            this.newControlFlowEdge(insn, call2 + 1);
                        }
