...
@AnnotationHelper(name="Crystals", category=Category.HUD)
public class CrystalsElement
extends Element {
    public CrystalsElement() {
        this.setWidth(16.0f);
        this.setHeight(16);
    }
    ...
    private void itemrender(ItemStack itemStack) {
        ...
        CrystalsElement.postitemrender();
    }
}
