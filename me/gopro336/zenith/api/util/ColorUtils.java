...
public class ColorUtils {
    ...
    public static int toRGBA(float[] colors2) {
        if (colors2.length != 4) {
            throw new IllegalArgumentException("colors[] must have a length of 4!");
        }
        return ColorUtils.toRGBA(colors2[0], colors2[1], colors2[2], colors2[3]);
    }

    public static int toRGBA(double[] colors2) {
        if (colors2.length != 4) {
            throw new IllegalArgumentException("colors[] must have a length of 4!");
        }
        return ColorUtils.toRGBA((float)colors2[0], (float)colors2[1], (float)colors2[2], (float)colors2[3]);
    }
