...
public class RotationManager {
    ...
    public void lookAtPos(BlockPos pos) {
        float[] angle = RotationManager.calculateAngle(this.mc.player.getPositionEyes(this.mc.getRenderPartialTicks()), new Vec3d((double)((float)pos.getX() + 0.5f), (double)((float)pos.getY() + 0.5f), (double)((float)pos.getZ() + 0.5f)));
