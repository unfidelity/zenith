...
public class CFont {
    ...
    protected DynamicTexture setupTexture(Font font, boolean antiAlias, boolean fractionalMetrics, CharData[] chars) {
        BufferedImage bufferedImage = this.generateFontImage(font, antiAlias, fractionalMetrics, chars);
        try {
            ...
            GL11.glTexImage2D((int)3553, (int)0, (int)6406, (int)bufferedImage.getWidth(), (int)bufferedImage.getHeight(), (int)0, (int)32993, (int)33639, (IntBuffer)null);
            GL11.glTexParameteri((int)3553, (int)33169, (int)0);
